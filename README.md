...
Aktuelle Version: **v11.4.2** (Basis: „Beacon", v11.4.0). Den vollständigen Verlauf findest du in der [CHANGELOG.md](CHANGELOG.md) sowie direkt im Tool über das **📜**-Symbol.
